...
class Event_List extends WP_List_Table {
	...
	public function __construct() {
		...
		parent::__construct( [
			'singular' => __( 'Event', 'se' ), //singular name of the listed records
			'plural'   => __( 'Events', 'se' ), //plural name of the listed records
	...
	function column_name( $item ) {
		...
		$delete_nonce = wp_create_nonce( 'se_delete_event' );
	...
	public function process_bulk_action() {
		...
		if ( 'delete' === $this->current_action() ) {
			...
			if ( ! wp_verify_nonce( $nonce, 'se_delete_event' ) ) {
